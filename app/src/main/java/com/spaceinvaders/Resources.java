...
//        Log.v("PlayFieldView", "Width Ratio <SPRITE_WIDTH> / <SCREEN_WIDTH>: " + img_player.getBitmap().getWidth() + " / " + playFieldWidth + " = " + ((float)img_player.getBitmap().getWidth() / (float)playFieldWidth));
        ...
        img_player_shield = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_shield, opt);
        img_player_laser_charge01 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge01, opt);
        img_player_laser_charge02 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge02, opt);
        img_player_laser_charge03 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge03, opt);
        img_player_laser_charge04 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge04, opt);
        img_player_laser_charge05 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge05, opt);
        img_player_laser_charge06 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge06, opt);
        img_player_laser_charge07 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge07, opt);
        img_player_laser_charge08 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge08, opt);
        img_player_laser_charge09 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge09, opt);
        img_player_laser_charge10 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge10, opt);
        img_player_laser_charge11 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge11, opt);
        img_player_laser_charge12 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge12, opt);
        img_player_laser_charge13 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge13, opt);
        img_player_laser_charge14 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge14, opt);
        img_player_laser_charge15 = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_lazer_charge15, opt);
        img_player_laser = BitmapFactory.decodeResource(context.getResources(), R.drawable.player_laser, opt);
        ...
        img_invader_laser01 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser01, opt);
        img_invader_laser_charge01 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge01, opt);
        img_invader_laser_charge02 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge02, opt);
        img_invader_laser_charge03 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge03, opt);
        img_invader_laser_charge04 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge04, opt);
        img_invader_laser_charge05 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge05, opt);
        img_invader_laser_charge06 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge06, opt);
        img_invader_laser_charge07 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge07, opt);
        img_invader_laser_charge08 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge08, opt);
        img_invader_laser_charge09 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge09, opt);
        img_invader_laser_charge10 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge10, opt);
        img_invader_laser_charge11 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge11, opt);
        img_invader_laser_charge12 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge12, opt);
        img_invader_laser_charge13 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge13, opt);
        img_invader_laser_charge14 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge14, opt);
        img_invader_laser_charge15 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge15, opt);
        img_invader_laser_charge16 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_laser_charge16, opt);
        img_invader_UFO_hit01 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_ufo_hit01, opt);
        img_invader_UFO01 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_ufo_flying01, opt);
        img_invader_UFO_firing01 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_ufo_firing01, opt);
        img_invader_UFO_firing02 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_ufo_firing02, opt);
        img_invader_UFO_firing03 = BitmapFactory.decodeResource(context.getResources(), R.drawable.invader_ufo_firing03, opt);
